...
export function WalletIndicator({ balance, compact = false }: WalletIndicatorProps) {
  return (
    <div className="flex min-h-11 items-center gap-2 rounded-full border border-line-strong bg-surface-2 py-1 pr-1 pl-3.5">
      {compact ? null : (
      ...
      <Link
        ...
        aria-label="Deposit"
        title="Deposit"
        className="relative flex size-8 items-center justify-center rounded-full bg-accent text-on-accent transition-colors duration-[120ms] after:absolute after:-inset-1.5 after:content-[''] hover:bg-accent-hi"
      >
