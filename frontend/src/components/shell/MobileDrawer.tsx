...
export function MobileDrawer() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex lg:hidden">
      ...
      <div className="relative flex w-80 max-w-[85vw] flex-col bg-panel">
        ...
        <div className="px-3 pb-3">
          <button
            ...
            className="flex min-h-11 w-full items-center gap-2.5 rounded-input bg-surface-1 px-3 text-[13.5px] text-ink-mute"
          >
